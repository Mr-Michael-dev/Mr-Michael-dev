  ...
  return (
    <section className="py-20 px-4">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-3xl font-bold mb-8 text-center bg-gradient-purple-pink bg-clip-text text-transparent">
          About Me
        </h2>
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            <h3 className="text-xl font-semibold mb-4 text-gradient-start hover:bg-gradient-purple-pink hover:bg-clip-text hover:text-transparent transition-all duration-300">
              Skills & Technologies
            </h3>
            <div className="flex flex-wrap gap-2">
              {skills.map((skill) => (
                <Badge
                  key={skill}
                  variant="secondary"
                  className="hover:-translate-y-1 hover:shadow-md hover:bg-gradient-purple-pink hover:text-white transition-all duration-300 cursor-default"
                >
                  {skill}
                </Badge>
              ))}
